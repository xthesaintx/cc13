...
async _restockShop(htmlElement, specificTableUuid = null) {
    ...
    //     let targetTables = [];
    //     if (specificTableUuid) {
    //         targetTables = allTables.filter(t => t.uuid === specificTableUuid);
    //     } else {
    ...
    //     let cachedInventory = []
    //     const activeSheet = Object.values(this.document.apps)[0];
    //     if (activeSheet && activeSheet._processedData) {
    //         cachedInventory = activeSheet._processedData.inventory;
    //     }
    //     else
    //     {
    ...
    //                         if (item) {
    //                             const existingItem = cachedInventory.find(i => i.itemUuid === item.uuid);
    //                             if (existingItem) {
    ...
    //                         }
    //                     } catch (error) {
    //                         console.warn(`Campaign Codex | Could not fetch item ${itemUuid}:`, error);
    //                     }
    //                 }
    //             }
    //         }
    ...
    //         await this.document.setFlag("campaign-codex", "data.inventory", inventory);
    //         ui.notifications.info(`Restocked ${totalItemsAdded} items.`);
    //         if (this.document.sheet?.rendered) this.document.sheet.render(false);
    //     } else {
    //         ui.notifications.warn("No valid items found in roll results.");
    //     }
    // }
